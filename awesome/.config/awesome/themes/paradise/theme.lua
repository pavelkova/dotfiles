...
theme.font          = "Lato Thin 14"

-- Get colors from WPG
theme.xbackground = wpg.background
theme.xforeground = wpg.foreground
...
-- local cool_color = awesome.wpg_get_value("", "color16")
...
theme.exit_screen_font = "Lato 20"
