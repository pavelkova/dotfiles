...
local user_picture = wibox.widget {
    wibox.widget.imagebox(os.getenv("HOME").."/.emacs.d/user/logo.svg"),
...
awful.spawn.easy_async_with_shell("hostname", function(out)
    ...
    out = out:gsub('^%s*(.-)%s*$', '%1')
    host_text.markup = helpers.colorize_text("@"..out, beautiful.xcolor9)
end)
-- host_text.markup = "<span foreground='" .. beautiful.xcolor8 .."'>" .. minutes.text .. "</span>"
host_text.font = "Lato Light Italic 18"
...
styles.header  = { fg_color = beautiful.xcolor7,
                   ...
                   markup   = function(t) return '<span font_desc="Lato bold 24">' .. t .. '</span>' end,
}
...
hours.font = "Lato Light 30"
hours.align = "center"
hours.valign = "center"
local minutes = wibox.widget.textclock("  %M")
minutes.font = "Lato 30"
...
day_of_the_week.font = "EtBembo Italic 20"
...
day_of_the_month.font = "Lato Light 32"
