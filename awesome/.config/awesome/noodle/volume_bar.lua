...
local function update_widget()
  awful.spawn.easy_async({"sh", "-c", "pactl list sinks"},
    function(stdout)
      ...
      volume_bar:get_all_children()[1].value = tonumber(volume)
      volume_bar:get_all_children()[1].color = fill_color
      volume_bar:get_all_children()[1].background_color = bg_color
    end
  )
end
